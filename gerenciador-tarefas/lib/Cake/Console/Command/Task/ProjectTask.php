 ...
 */
	protected function _replaceCorePath($filename, $hardCode) {
		...
		$composer = ROOT . DS . APP_DIR . DS . 'Vendor' . DS . 'gerenciador-tarefas' . DS . 'gerenciador-tarefas' . DS . 'lib';
		if (file_exists($composer)) {
			$corePath = " ROOT . DS . APP_DIR . DS . 'Vendor' . DS . 'gerenciador-tarefas' . DS . 'gerenciador-tarefas' . DS . 'lib'";
		}
