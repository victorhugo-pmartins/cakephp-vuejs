...
if (!defined('FULL_BASE_URL')) {
	define('FULL_BASE_URL', 'http://gerenciador-tarefas.org');
}
 ...
 */
	public function testLink() {
		...
		$result = $this->Html->link('alert', 'javascript:alert(\'gerenciador-tarefas\');');
		$expected = array('a' => array('href' => 'javascript:alert(&#039;gerenciador-tarefas&#039;);'), 'alert', '/a');
		$this->assertTags($result, $expected);

		$result = $this->Html->link('write me', 'mailto:example@gerenciador-tarefas.org');
		$expected = array('a' => array('href' => 'mailto:example@gerenciador-tarefas.org'), 'write me', '/a');
		$this->assertTags($result, $expected);
		...
		$result = $this->Html->link('say hello to 0123465-798', 'sms:0123465-798?body=hello "gerenciador-tarefas"');
		$expected = array('a' => array('href' => 'sms:0123465-798?body=hello &quot;gerenciador-tarefas&quot;'), 'say hello to 0123465-798', '/a');
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testImagePathPrefix() {
		...
		$result = $this->Html->image('test.gif', array('pathPrefix' => 'http://gerenciador-tarefas.org/assets/img/'));
		$this->assertTags($result, array('img' => array('src' => 'http://gerenciador-tarefas.org/assets/img/test.gif', 'alt' => '')));

		$result = $this->Html->image('test.gif', array('pathPrefix' => '//gerenciador-tarefas.org/assets/img/'));
		$this->assertTags($result, array('img' => array('src' => '//gerenciador-tarefas.org/assets/img/test.gif', 'alt' => '')));

		$previousConfig = Configure::read('App.imageBaseUrl');
		Configure::write('App.imageBaseUrl', '//cdn.gerenciador-tarefas.org/img/');
		$result = $this->Html->image('test.gif');
		$this->assertTags($result, array('img' => array('src' => '//cdn.gerenciador-tarefas.org/img/test.gif', 'alt' => '')));
 ...
 */
	public function testCssLink() {
		...
		$result = $this->Html->css('cake.generic', array('pathPrefix' => 'http://gerenciador-tarefas.org/assets/css/'));
		$expected['link']['href'] = 'http://gerenciador-tarefas.org/assets/css/cake.generic.css';
		$this->assertTags($result, $expected);

		$previousConfig = Configure::read('App.cssBaseUrl');
		Configure::write('App.cssBaseUrl', '//cdn.gerenciador-tarefas.org/css/');
		$result = $this->Html->css('cake.generic');
		$expected['link']['href'] = '//cdn.gerenciador-tarefas.org/css/cake.generic.css';
		$this->assertTags($result, $expected);
 ...
 */
	public function testScript() {
		...
		$result = $this->Html->script('foo3', array('pathPrefix' => 'http://gerenciador-tarefas.org/assets/js/'));
		$expected = array(
			'script' => array('type' => 'text/javascript', 'src' => 'http://gerenciador-tarefas.org/assets/js/foo3.js')
		);
		$this->assertTags($result, $expected);

		$previousConfig = Configure::read('App.jsBaseUrl');
		Configure::write('App.jsBaseUrl', '//cdn.gerenciador-tarefas.org/js/');
		$result = $this->Html->script('foo4');
		$expected = array(
			'script' => array('type' => 'text/javascript', 'src' => '//cdn.gerenciador-tarefas.org/js/foo4.js')
		);
		$this->assertTags($result, $expected);
