 ...
 */
	public function testAutoLink() {
		...
		$text = 'Text with a partial www.gerenciador-tarefas.org URL and test@gerenciador-tarefas.org email address';
		$result = $this->Text->autoLink($text);
		$expected = 'Text with a partial <a href="http://www.gerenciador-tarefas.org">www.gerenciador-tarefas.org</a> URL and <a href="mailto:test@gerenciador-tarefas\.org">test@gerenciador-tarefas\.org</a> email address';
		$this->assertRegExp('#^' . $expected . '$#', $result);

		$text = 'Text with a partial <a href="//www.gerenciador-tarefas.org">link</a> link';
		$result = $this->Text->autoLink($text, array('escape' => false));
		$this->assertEquals($text, $result);

		$text = 'This is a test text with URL http://www.gerenciador-tarefas.org';
		$expected = 'This is a test text with URL <a href="http://www.gerenciador-tarefas.org">http://www.gerenciador-tarefas.org</a>';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);

		$text = 'This is a test text with URL http://www.gerenciador-tarefas.org and some more text';
		$expected = 'This is a test text with URL <a href="http://www.gerenciador-tarefas.org">http://www.gerenciador-tarefas.org</a> and some more text';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);
		...
		$text = 'This is a test text with URL (http://www.gerenciador-tarefas.org/page/4) in brackets';
		$expected = 'This is a test text with URL (<a href="http://www.gerenciador-tarefas.org/page/4">http://www.gerenciador-tarefas.org/page/4</a>) in brackets';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);

		$text = 'This is a test text with URL [http://www.gerenciador-tarefas.org/page/4] in square brackets';
		$expected = 'This is a test text with URL [<a href="http://www.gerenciador-tarefas.org/page/4">http://www.gerenciador-tarefas.org/page/4</a>] in square brackets';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);
		...
		$text = 'This is a test text with URL ;http://www.gerenciador-tarefas.org/page/4; semi-colon';
		$expected = 'This is a test text with URL ;<a href="http://www.gerenciador-tarefas.org/page/4">http://www.gerenciador-tarefas.org/page/4</a>; semi-colon';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);

		$text = 'This is a test text with URL (http://www.gerenciador-tarefas.org/page/4/other(thing)) brackets';
		$expected = 'This is a test text with URL (<a href="http://www.gerenciador-tarefas.org/page/4/other(thing)">http://www.gerenciador-tarefas.org/page/4/other(thing)</a>) brackets';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testAutoLinkOptions() {
		$text = 'This is a test text with URL http://www.gerenciador-tarefas.org';
		$expected = 'This is a test text with URL <a href="http://www.gerenciador-tarefas.org" class="link">http://www.gerenciador-tarefas.org</a>';
		$result = $this->Text->autoLink($text, array('class' => 'link'));
		$this->assertEquals($expected, $result);

		$text = 'This is a test text with URL http://www.gerenciador-tarefas.org';
		$expected = 'This is a test text with URL <a href="http://www.gerenciador-tarefas.org" class="link" id="MyLink">http://www.gerenciador-tarefas.org</a>';
 ...
 */
	public function testAutoLinkEscape() {
		$text = 'This is a <b>test</b> text with URL http://www.gerenciador-tarefas.org';
		$expected = 'This is a &lt;b&gt;test&lt;/b&gt; text with URL <a href="http://www.gerenciador-tarefas.org">http://www.gerenciador-tarefas.org</a>';
		$result = $this->Text->autoLink($text);
		$this->assertEquals($expected, $result);
 ...
 */
	public static function autoLinkProvider() {
		return array(
			...
			array(
				'This is a test that includes (www.gerenciador-tarefas.org)',
				'This is a test that includes (<a href="http://www.gerenciador-tarefas.org">www.gerenciador-tarefas.org</a>)',
			),
			array(
				'This is a test that includes www.gerenciador-tarefas.org:8080',
				'This is a test that includes <a href="http://www.gerenciador-tarefas.org:8080">www.gerenciador-tarefas.org:8080</a>',
			),
			array(
			...
			array(
				'Text with a partial www.gerenciador-tarefas.org URL',
				'Text with a partial <a href="http://www.gerenciador-tarefas.org">www.gerenciador-tarefas.org</a> URL',
			),
			array(
				'Text with a partial WWW.gerenciador-tarefas.org URL',
				'Text with a partial <a href="http://WWW.gerenciador-tarefas.org">WWW.gerenciador-tarefas.org</a> URL',
			...
			array(
				'Text with a partial WWW.gerenciador-tarefas.org &copy, URL',
				'Text with a partial <a href="http://WWW.gerenciador-tarefas.org">WWW.gerenciador-tarefas.org</a> &amp;copy, URL',
			),
			array(
 ...
 */
	public function testAutoLinkUrlsOptions() {
		$text = 'Text with a partial www.gerenciador-tarefas.org URL';
		$expected = 'Text with a partial <a href="http://www.gerenciador-tarefas.org" \s*class="link">www.gerenciador-tarefas.org</a> URL';
		$result = $this->Text->autoLinkUrls($text, array('class' => 'link'));
		$this->assertRegExp('#^' . $expected . '$#', $result);

		$text = 'Text with a partial WWW.gerenciador-tarefas.org &copy; URL';
		$expected = 'Text with a partial <a href="http://WWW.gerenciador-tarefas.org"\s*>WWW.gerenciador-tarefas.org</a> &copy; URL';
 ...
 */
	public function testAutoLinkUrlsEscape() {
		...
		$text = 'Text with a partial <a href="http://www.gerenciador-tarefas.org">link</a> link';
		$expected = 'Text with a partial <a href="http://www.gerenciador-tarefas.org">link</a> link';
		$result = $this->Text->autoLinkUrls($text, array('escape' => false));
		$this->assertEquals($expected, $result);

		$text = 'Text with a partial <iframe src="http://www.gerenciador-tarefas.org" /> link';
		$expected = 'Text with a partial <iframe src="http://www.gerenciador-tarefas.org" /> link';
		$result = $this->Text->autoLinkUrls($text, array('escape' => false));
		$this->assertEquals($expected, $result);
 ...
 */
	public function testAutoLinkUrlsQueryString() {
		$text = 'Text with a partial http://www.gerenciador-tarefas.org?product_id=123&foo=bar link';
		$expected = 'Text with a partial <a href="http://www.gerenciador-tarefas.org?product_id=123&amp;foo=bar">http://www.gerenciador-tarefas.org?product_id=123&amp;foo=bar</a> link';
		$result = $this->Text->autoLinkUrls($text);
		$this->assertEquals($expected, $result);
	}
