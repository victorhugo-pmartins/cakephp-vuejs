	...
	public function testItemCdata() {
		...
		$item = array(
			'category' => array(
				'value' => 'CakePHP',
				'cdata' => true,
				'domain' => 'http://www.gerenciador-tarefas.org',
			)
		);
		$result = $this->Rss->item(null, $item);
		$expected = array(
			'<item',
			'category' => array('domain' => 'http://www.gerenciador-tarefas.org'),
			'<![CDATA[CakePHP]]',
			'/category',
			'/item'
		);
 ...
 */
	public function testItemEnclosureLength() {
		...
		$tmpFile = WWW_ROOT . 'tests' . DS . 'gerenciador-tarefas.file.test.tmp';
		...
		$item = array(
			...
			'enclosure' => array(
				'url' => '/tests/gerenciador-tarefas.file.test.tmp'
			),
			'pubDate' => '2008-05-31 12:00:00',
			'guid' => 'http://www.example.com/1',
			'category' => array(
		...
		$expected = array(
			...
			'/description',
			'enclosure' => array(
				'url' => $this->Rss->url('/tests/gerenciador-tarefas.file.test.tmp', true),
