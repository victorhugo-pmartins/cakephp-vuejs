 ...
 */
	public function testSetHost() {
		TestCakeSession::init();
		TestCakeSession::setHost('gerenciador-tarefas.org');
		$this->assertEquals('gerenciador-tarefas.org', TestCakeSession::$host);
	}
 ...
 */
	public function testSetHostWithPort() {
		TestCakeSession::init();
		TestCakeSession::setHost('gerenciador-tarefas.org:443');
		$this->assertEquals('gerenciador-tarefas.org', TestCakeSession::$host);
	}
