 ...
 */
	public static function joinStatements() {
		return array(
			...
			), 'CROSS JOIN gerenciador-tarefas.posts_tags AS PostsTag'),
			array(array(
				'type' => 'LEFT',
				'alias' => 'PostsTag',
				'table' => 'posts_tags',
			), 'LEFT JOIN gerenciador-tarefas.posts_tags AS PostsTag'),
			array(array(
				'type' => 'LEFT',
				'alias' => 'PostsTag',
				'table' => 'posts_tags',
				'conditions' => array('PostsTag.post_id = Post.id')
			), 'LEFT JOIN gerenciador-tarefas.posts_tags AS PostsTag ON (PostsTag.post_id = Post.id)'),
			array(array(
				'type' => 'LEFT',
				'alias' => 'Stock',
 ...
 */
	public function testBuildJoinStatement($join, $expected) {
		...
		$db->expects($this->any())
			...
			->will($this->returnValue('gerenciador-tarefas'));
