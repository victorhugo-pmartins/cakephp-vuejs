 ...
 */
	public function testHABTMKeepExisting() {
		...
		// include api.gerenciador-tarefas.org
		$data['Domain'] = array('Domain' => array(1, 2, 3));
		$Site->save($data);

		$Site->id = 1;
		$results = $Site->read();
		$expected = 3; // 3 domains belonging to gerenciador-tarefas
		...
		// activate api.gerenciador-tarefas.org
		...
		$data = array(
			'Site' => array('id' => 1, 'name' => 'gerenciador-tarefas (modified)'),
			'Domain' => array(
				'Domain' => array(3),
			)
		);
