 ...
 */
	public function testParseHeader() {
		...
		$header = "Host: gerenciador-tarefas.org\t\r\n";
 ...
 */
	public function testParseCookies() {
		...
		$header['Set-Cookie'][] = 'gerenciador-tarefas=great; Secure';
		$expected['gerenciador-tarefas'] = array('value' => 'great', 'secure' => true);
		$cookies = $this->HttpResponse->parseCookies($header);
		$this->assertEquals($expected, $cookies);

		$header['Set-Cookie'] = 'foo=bar';
		unset($expected['people'], $expected['gerenciador-tarefas'], $expected['google']);
		$cookies = $this->HttpResponse->parseCookies($header);
		$this->assertEquals($expected, $cookies);
	}
