 ...
 */
	public function testHeaderDetector() {
		...
		$request->addDetector('host', array('header' => array('host' => 'gerenciador-tarefas.org')));

		$_SERVER['HTTP_HOST'] = 'gerenciador-tarefas.org';
 ...
 */
	public function testQueryStringAndNamedParams() {
		...
		$_SERVER['REQUEST_URI'] = '/some/path?url=http://gerenciador-tarefas.org';
		$request = new CakeRequest();
		$this->assertEquals('some/path', $request->url);

		$_SERVER['REQUEST_URI'] = Configure::read('App.fullBaseUrl') . '/other/path?url=http://gerenciador-tarefas.org';
		$request = new CakeRequest();
 ...
 */
	public function testReferer() {
		...
		$_SERVER['HTTP_REFERER'] = 'http://gerenciador-tarefas.org';
		$result = $request->referer();
		$this->assertSame($result, 'http://gerenciador-tarefas.org');
 ...
 */
	public function testHost() {
		...
		$_SERVER['HTTP_X_FORWARDED_HOST'] = 'gerenciador-tarefas.org';
		$request = new CakeRequest('some/path');

		$this->assertEquals('localhost', $request->host());
		$this->assertEquals('gerenciador-tarefas.org', $request->host(true));
	}
 ...
 */
	public function testBaseUrlWithModRewriteAndIndexPhp() {
		$_SERVER['REQUEST_URI'] = '/gerenciador-tarefas/app/webroot/index.php';
		$_SERVER['PHP_SELF'] = '/gerenciador-tarefas/app/webroot/index.php';
		unset($_SERVER['PATH_INFO']);
		$request = new CakeRequest();

		$this->assertEquals('/gerenciador-tarefas', $request->base);
		$this->assertEquals('/gerenciador-tarefas/', $request->webroot);
		$this->assertEquals('', $request->url);
		$this->assertEquals('/gerenciador-tarefas/', $request->here);
		...
		$_SERVER['REQUEST_URI'] = '/gerenciador-tarefas/app/webroot/index.php/apples';
		$_SERVER['PHP_SELF'] = '/gerenciador-tarefas/app/webroot/index.php/apples';
		...
		$this->assertEquals('/gerenciador-tarefas/apples', $request->here);

		$_SERVER['REQUEST_URI'] = '/gerenciador-tarefas/app/webroot/index.php/melons/share/';
		$_SERVER['PHP_SELF'] = '/gerenciador-tarefas/app/webroot/index.php/melons/share/';
		...
		$this->assertEquals('/gerenciador-tarefas/melons/share/', $request->here);

		$_SERVER['REQUEST_URI'] = '/gerenciador-tarefas/app/webroot/index.php/bananas/eat/tasty_banana';
		$_SERVER['PHP_SELF'] = '/gerenciador-tarefas/app/webroot/index.php/bananas/eat/tasty_banana';
		...
		$this->assertEquals('/gerenciador-tarefas/bananas/eat/tasty_banana', $request->here);
	}
 ...
 */
	public function testBaseUrlWithModRewriteAndExtraSlashes() {
		$_SERVER['REQUEST_URI'] = '/gerenciador-tarefas/webroot///index.php/bananas/eat';
		$_SERVER['PHP_SELF'] = '/gerenciador-tarefas/webroot///index.php/bananas/eat';
		...
		$this->assertEquals('/gerenciador-tarefas/bananas/eat', $request->here);
	}
