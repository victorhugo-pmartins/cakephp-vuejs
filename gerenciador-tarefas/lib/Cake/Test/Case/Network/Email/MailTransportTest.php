 ...
 */
	public function testSendData() {
		...
		$data = "From: CakePHP Test <noreply@gerenciador-tarefas.org>" . PHP_EOL;
		$data .= "Return-Path: CakePHP Return <pleasereply@gerenciador-tarefas.org>" . PHP_EOL;
		$data .= "Cc: Mark Story <mark@gerenciador-tarefas.org>, Juan Basso <juan@gerenciador-tarefas.org>" . PHP_EOL;
		$data .= "Bcc: phpnut@gerenciador-tarefas.org" . PHP_EOL;
		...
		$this->MailTransport->expects($this->once())->method('_mail')
			->with(
				'CakePHP <cake@gerenciador-tarefas.org>',
				$encoded,
