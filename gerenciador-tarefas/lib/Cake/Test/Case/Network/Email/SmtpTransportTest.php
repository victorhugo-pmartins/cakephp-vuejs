 ...
 */
	public function testRcpt() {
		$email = new CakeEmail();
		$email->from('noreply@gerenciador-tarefas.org', 'CakePHP Test');
		$email->to('cake@gerenciador-tarefas.org', 'CakePHP');
		$email->bcc('phpnut@gerenciador-tarefas.org');
		$email->cc(array('mark@gerenciador-tarefas.org' => 'Mark Story', 'juan@gerenciador-tarefas.org' => 'Juan Basso'));

		$this->socket->expects($this->at(0))->method('write')->with("MAIL FROM:<noreply@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(1))->method('read')->will($this->returnValue(false));
		$this->socket->expects($this->at(2))->method('read')->will($this->returnValue("250 OK\r\n"));
		$this->socket->expects($this->at(3))->method('write')->with("RCPT TO:<cake@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(4))->method('read')->will($this->returnValue(false));
		$this->socket->expects($this->at(5))->method('read')->will($this->returnValue("250 OK\r\n"));
		$this->socket->expects($this->at(6))->method('write')->with("RCPT TO:<mark@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(7))->method('read')->will($this->returnValue(false));
		$this->socket->expects($this->at(8))->method('read')->will($this->returnValue("250 OK\r\n"));
		$this->socket->expects($this->at(9))->method('write')->with("RCPT TO:<juan@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(10))->method('read')->will($this->returnValue(false));
		$this->socket->expects($this->at(11))->method('read')->will($this->returnValue("250 OK\r\n"));
		$this->socket->expects($this->at(12))->method('write')->with("RCPT TO:<phpnut@gerenciador-tarefas.org>\r\n");
 ...
 */
	public function testRcptWithReturnPath() {
		...
		$email->from('noreply@gerenciador-tarefas.org', 'CakePHP Test');
		$email->to('cake@gerenciador-tarefas.org', 'CakePHP');
		$email->returnPath('pleasereply@gerenciador-tarefas.org', 'CakePHP Return');

		$this->socket->expects($this->at(0))->method('write')->with("MAIL FROM:<pleasereply@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(1))->method('read')->will($this->returnValue(false));
		$this->socket->expects($this->at(2))->method('read')->will($this->returnValue("250 OK\r\n"));
		$this->socket->expects($this->at(3))->method('write')->with("RCPT TO:<cake@gerenciador-tarefas.org>\r\n");
		$this->socket->expects($this->at(4))->method('read')->will($this->returnValue(false));
 ...
 */
	public function testSendData() {
		...
		$data = "From: CakePHP Test <noreply@gerenciador-tarefas.org>\r\n";
		$data .= "To: CakePHP <cake@gerenciador-tarefas.org>\r\n";
		$data .= "Cc: Mark Story <mark@gerenciador-tarefas.org>, Juan Basso <juan@gerenciador-tarefas.org>\r\n";
