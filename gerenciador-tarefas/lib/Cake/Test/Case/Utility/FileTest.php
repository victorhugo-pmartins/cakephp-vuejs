 ...
 */
	public function testCreate() {
		$tmpFile = TMP . 'tests' . DS . 'gerenciador-tarefas.file.test.tmp';
 ...
 */
	public function testExists() {
		$tmpFile = TMP . 'tests/gerenciador-tarefas.file.test.tmp';
		$file = new File($tmpFile, true, 0777);
 ...
 */
	public function testCopy() {
		$dest = TMP . 'tests' . DS . 'gerenciador-tarefas.file.test.tmp';
		$file = __FILE__;
		$this->File = new File($file);
 ...
 */
	public function testReplaceText() {
		...
		$TmpFile = new File(TMP . 'tests' . DS . 'gerenciador-tarefas.file.test.tmp');
