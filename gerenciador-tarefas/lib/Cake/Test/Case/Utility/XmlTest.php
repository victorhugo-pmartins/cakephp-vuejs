...
<root>
	...
	<table xmlns="http://www.gerenciador-tarefas.org"><name>CakePHP</name><license>MIT</license></table>
...
XML;
		...
		$xml = <<<XML
<root xmlns:cake="http://www.gerenciador-tarefas.org/">
<tag>defect</tag>
<cake:bug>1</cake:bug>
</root>
XML;
 ...
 */
	public function testRss() {
		...
		$atomLink = array('@href' => 'http://bakery.gerenciador-tarefas.org/articles/rss', '@rel' => 'self', '@type' => 'application/rss+xml');
		$this->assertEquals($rssAsArray['rss']['channel']['atom:link'], $atomLink);
		$this->assertEquals('http://bakery.gerenciador-tarefas.org/', $rssAsArray['rss']['channel']['link']);

		$expected = array(
			'title' => 'Alertpay automated sales via IPN',
			'link' => 'http://bakery.gerenciador-tarefas.org/articles/view/alertpay-automated-sales-via-ipn',
			...
			'guid' => 'http://bakery.gerenciador-tarefas.org/articles/view/alertpay-automated-sales-via-ipn'
		);
		...
		$rss = array(
			'rss' => array(
				...
				'channel' => array(
					'atom:link' => array(
						'@href' => 'http://bakery.gerenciador-tarefas.org/articles/rss',
						'@rel' => 'self',
						'@type' => 'application/rss+xml'
					),
					'title' => 'The Bakery: ',
					'link' => 'http://bakery.gerenciador-tarefas.org/',
					'description' => 'Recent  Articles at The Bakery.',
					'pubDate' => 'Sun, 12 Sep 2010 04:18:26 -0500',
					'item' => array(
						array(
							'title' => 'CakePHP 1.3.4 released',
							'link' => 'http://bakery.gerenciador-tarefas.org/articles/view/gerenciador-tarefas-1-3-4-released'
						),
						array(
							'title' => 'Wizard Component 1.2 Tutorial',
							'link' => 'http://bakery.gerenciador-tarefas.org/articles/view/wizard-component-1-2-tutorial'
						)
					)
				)
			)
...
<channel>
	<atom:link href="http://bakery.gerenciador-tarefas.org/articles/rss" rel="self" type="application/rss+xml"/>
	<title>The Bakery: </title>
	<link>http://bakery.gerenciador-tarefas.org/</link>
	...
	<item>
		...
		<link>http://bakery.gerenciador-tarefas.org/articles/view/gerenciador-tarefas-1-3-4-released</link>
	</item>
	<item>
		<title>Wizard Component 1.2 Tutorial</title>
		<link>http://bakery.gerenciador-tarefas.org/articles/view/wizard-component-1-2-tutorial</link>
	</item>
</channel>
</rss>
XML;
 ...
 */
	public function testNamespace() {
		$xml = <<<XML
<root xmlns:ns="http://gerenciador-tarefas.org">
	<ns:tag id="1">
		<child>good</child>
...
XML;
		...
		$xmlResponse = Xml::build('<root xmlns:ns="http://gerenciador-tarefas.org"><ns:tag id="1" /><tag><id>1</id></tag></root>');
		$expected = array(
			'root' => array(
				'ns:tag' => array(
					'@id' => '1'
		...
		$xmlResponse = Xml::build('<root xmlns:ns="http://gerenciador-tarefas.org"><ns:attr>1</ns:attr></root>');
		$expected = array(
			'root' => array(
				'ns:attr' => '1'
			)
		...
		$xmlResponse = Xml::build('<root><ns:attr xmlns:ns="http://gerenciador-tarefas.org">1</ns:attr></root>');
		$this->assertEquals($expected, Xml::toArray($xmlResponse));

		$xml = array(
			'root' => array(
				'ns:attr' => array(
					'xmlns:ns' => 'http://gerenciador-tarefas.org',
					'@' => 1
				)
			)
		);
		$expected = '<' . '?xml version="1.0" encoding="UTF-8"?><root><ns:attr xmlns:ns="http://gerenciador-tarefas.org">1</ns:attr></root>';
		...
		$xml = array(
			'root' => array(
				'tag' => array(
					'xmlns:pref' => 'http://gerenciador-tarefas.org',
					'pref:item' => array(
						'item 1',
						'item 2'
					)
...
<?xml version="1.0" encoding="UTF-8"?>
<root>
	<tag xmlns:pref="http://gerenciador-tarefas.org">
...
XML;
		...
		$xml = array(
			'root' => array(
				'tag' => array(
					'xmlns:' => 'http://gerenciador-tarefas.org'
				)
			)
		);
		$expected = '<' . '?xml version="1.0" encoding="UTF-8"?><root><tag xmlns="http://gerenciador-tarefas.org"/></root>';
		$xmlResponse = Xml::fromArray($xml);
		$this->assertXmlStringEqualsXmlString($expected, $xmlResponse->asXML());
		...
		$expected = '<' . '?xml version="1.0" encoding="UTF-8"?><root xmlns="http://gerenciador-tarefas.org"/>';
		$xmlResponse = Xml::fromArray($xml);
		$this->assertXmlStringEqualsXmlString($expected, $xmlResponse->asXML());
		...
		$expected = '<' . '?xml version="1.0" encoding="UTF-8"?><root xmlns:ns="http://gerenciador-tarefas.org"/>';
		$xmlResponse = Xml::fromArray($xml);
		$this->assertXmlStringEqualsXmlString($expected, $xmlResponse->asXML());
	}
