 ...
 */
	public function testEmailDeep() {
		...
		$this->assertTrue(Validation::email('abc.efg@gerenciador-tarefas.org', true));
 ...
 */
	public function testEmailCustomRegex() {
		$this->assertTrue(Validation::email('abc.efg@gerenciador-tarefas.org', null, '/^[A-Z0-9._%-]+@[A-Z0-9.-]+\\.[A-Z]{2,4}$/i'));
 ...
 */
	public function testUrl() {
		$this->assertTrue(Validation::url('http://www.gerenciador-tarefas.org'));
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org'));
		$this->assertTrue(Validation::url('http://www.gerenciador-tarefas.org/somewhere#anchor'));
		$this->assertTrue(Validation::url('http://192.168.0.1'));
		$this->assertTrue(Validation::url('https://www.gerenciador-tarefas.org'));
		$this->assertTrue(Validation::url('https://gerenciador-tarefas.org'));
		$this->assertTrue(Validation::url('https://www.gerenciador-tarefas.org/somewhere#anchor'));
		$this->assertTrue(Validation::url('https://192.168.0.1'));
		$this->assertTrue(Validation::url('ftps://www.gerenciador-tarefas.org/pub/cake'));
		$this->assertTrue(Validation::url('ftps://gerenciador-tarefas.org/pub/cake'));
		$this->assertTrue(Validation::url('ftps://192.168.0.1/pub/cake'));
		$this->assertTrue(Validation::url('ftp://www.gerenciador-tarefas.org/pub/cake'));
		$this->assertTrue(Validation::url('ftp://gerenciador-tarefas.org/pub/cake'));
		...
		$this->assertTrue(Validation::url('http://www.gerenciador-tarefas.org', true));
		...
		$this->assertFalse(Validation::url('www.gerenciador-tarefas.org', true));
		...
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org:80'));
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org:443'));
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org:2000'));
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org:27000'));
		$this->assertTrue(Validation::url('http://gerenciador-tarefas.org:65000'));
