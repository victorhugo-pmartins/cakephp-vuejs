 ...
 *
 * ### Full URI
 * e.g `cors($request, 'http://www.gerenciador-tarefas.org');`
 *
 * ### URI with wildcard
 * e.g `cors($request, 'http://*.gerenciador-tarefas.org');`
 *
 * ### Ignoring the requested protocol
 * e.g `cors($request, 'www.gerenciador-tarefas.org');`
 *
 * ### Any URI
 * e.g `cors($request, '*');`
 *
 * ### Whitelist of URIs
 * e.g `cors($request, array('http://www.gerenciador-tarefas.org', '*.google.com', 'https://myproject.github.io'));`
 *
 * @param CakeRequest $request Request object
