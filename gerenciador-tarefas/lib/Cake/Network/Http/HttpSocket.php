 ...
 * all other options:
 *
 * `$http = new HttpSocket('http://gerenciador-tarefas.org/');`
 *
 ...
 *
 * `$response = $http->get('http://google.com/search', array('q' => 'gerenciador-tarefas', 'client' => 'safari'));`
 *
 * Would do a GET request to `http://google.com/search?q=gerenciador-tarefas&client=safari`
 *
 ...
 *     array('q' => 'gerenciador-tarefas', 'client' => 'safari')
 * );
 * ```
 *
 ...
 *
 * ```
 * $http = new HttpSocket('http://www.gerenciador-tarefas.org');
 * $url = $http->url('/search?q=bar');
 * ```
 *
 * Would return `http://www.gerenciador-tarefas.org/search?q=bar`
 *
 * url() can also be used with custom templates:
 *
 * `$url = $http->url('http://www.gerenciador-tarefas/search?q=socket', '/%path?%query');`
 *
